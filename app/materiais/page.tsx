...
function MateriaisContent() {
  ...
  const handleDeletar = async (id: string) => {
    if (confirm(t.confirmarDeletarMaterial)) {
  ...
  const formatarQuantidadeComprada = (material: Material) => {
    if (
      material.tipoMedicao === "area" &&
      material.larguraComprada &&
      material.alturaComprada
    ) {
      return `${material.larguraComprada}cm × ${material.alturaComprada}cm`;
    } else if (
      material.tipoMedicao === "comprimento" &&
      material.comprimentoComprado
    ) {
    ...
    return (
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          />
          <p style={{ color: "#6B7280" }}>{t.carregandoMateriais}</p>
        </div>
      </div>
    );
  }
      ...
      <div className="content-wrapper">
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          >
            ...
            >
              ...
              <span className="btn-text">{t.novoMaterial}</span>
            </Link>
          </div>
          <p style={{ color: "#6B7280", fontSize: "14px", margin: 0 }}>
            {t.materiaisSubtitulo}
          </p>
        </div>
        ...
        {materiais.length === 0 ? (
          ...
          >
            ...
            >
              {t.nenhumMaterialCadastrado}
            </h3>
            <p style={{ color: "#6B7280", marginBottom: "24px" }}>
              {t.nenhumMaterialDesc}
            </p>
            <Link
              href="/materiais/novo"
              style={{
            ...
            >
              <Plus size={20} />
              <span>{t.adicionarPrimeiroMaterial}</span>
            </Link>
          </div>
        ) : (
          <>
            ...
            >
              ...
              >
                <div></div>
                <div>{t.colunaMaterial}</div>
                <div>{t.colunaQuantidadeComprada}</div>

                <div>{t.colunaPrecoCompra}</div>
                <div style={{ textAlign: "center" }}>{t.colunaAcoes}</div>
              </div>
              ...
              {materiais.map((material, index) => (
                ...
                >
                  ...
                  >
                    {t.moeda} {material.precoCompra.toFixed(2)}
                  </div>
