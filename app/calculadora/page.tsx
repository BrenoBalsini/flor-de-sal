...
} from "../../src/services/produtosService";
import {
  Calculator,
  Plus,
  Trash2,
...
function CalculadoraContent() {
  ...
  const [margemLucroCustom, setMargemLucroCustom] = useState<number | null>(
    null,
  );
  ...
  const handleEditarMaterial = (index: number) => {
    ...
    const materialOriginal = materiais.find(
  ...
  const handleSalvarNoHistorico = async () => {
    ...
    const custoMateriais = materiaisUsados.reduce(
      (acc, m) => acc + m.custoTotal,
      0,
    );
    ...
    const margemFinal =
      margemLucroCustom !== null ? margemLucroCustom : config.margemLucro;
    ...
    if (resultado.success) {
      alert(t.produtoSalvo);
      router.push("/historico");
    } else {
      alert(t.erroSalvarProduto);
    }
    ...
    return (
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          />
          <p style={{ color: "#6B7280" }}>{t.carregandoCalculadora}</p>
        </div>
      </div>
    );
  }
      ...
      <div className="content-wrapper">
        ...
        >
          ...
          {materiaisUsados.length === 0 ? (
            ...
            >
              ...
              />
              <p style={{ margin: 0 }}>{t.nenhumMaterialAdicionado}</p>
            </div>
          ) : (
            <div
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                <select
                  ...
                  style={{
                    ...
                    outline: "none",
                    backgroundColor:
                      editandoIndex !== null ? "#F3F4F6" : "white",
                  }}
                >
                  ...
                  {materialSelecionado.tipoMedicao === "unidade" && (
                    <div style={{ marginBottom: "16px" }}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setQuantidadeUsada(parseFloat(e.target.value) || 0)
                        }
                        style={{
                          width: "100%",
                          padding: "10px 12px",
                  ...
                  {materialSelecionado.tipoMedicao === "comprimento" && (
                    <div style={{ marginBottom: "16px" }}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setComprimentoUsado(parseFloat(e.target.value) || 0)
                        }
                        style={{
                          width: "100%",
                          padding: "10px 12px",
                    ...
                    >
                      <div>
                        ...
                        <input
                          ...
                          value={larguraUsada}
                          onChange={(e) =>
                            setLarguraUsada(parseFloat(e.target.value) || 0)
                          }
                          style={{
                            width: "100%",
                            padding: "10px 12px",
                      ...
                      <div>
                        ...
                        <input
                          ...
                          value={alturaUsada}
                          onChange={(e) =>
                            setAlturaUsada(parseFloat(e.target.value) || 0)
                          }
                          style={{
                            width: "100%",
                            padding: "10px 12px",
              ...
              <div style={{ display: "flex", gap: "12px", marginTop: "20px" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: "10px",
                    border: "none",
                    backgroundColor: materialSelecionado
                      ? "#00FFCC"
                      : "#9CA3AF",
                    color: "#111827",
                    borderRadius: "8px",
                ...
                >
                  {editandoIndex !== null ? t.atualizar : t.adicionar}
                </button>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <input
            ...
            placeholder={t.placeholderTempo}
            style={{
              width: "100%",
              padding: "12px 14px",
              border: "2px solid #D1D5DB",
          ...
          />
          <p
            style={{ fontSize: "13px", color: "#6B7280", margin: "8px 0 0 0" }}
          >
            💡{" "}
            {tempoProducao >= 60
              ? `${Math.floor(tempoProducao / 60)}h${tempoProducao % 60 > 0 ? `${tempoProducao % 60}min` : ""}`
              : `${tempoProducao} minuto(s)`}
          </p>
        </div>
        ...
        {calculado && (
          <>
            ...
            >
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                >
                  ...
                  >
                    {t.moeda} {custoMateriais.toFixed(2)}
                  </span>
                </div>
                <div
                  style={{
                ...
                >
                  <span style={{ fontSize: "14px", color: "#6B7280" }}>
                    {t.maoDeObra} ({tempoProducao} {t.minutos}):
                  </span>
                  <span
                    style={{
                      fontSize: "14px",
                  ...
                  >
                    {t.moeda} {custoMaoDeObra.toFixed(2)}
                  </span>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    <input
                      ...
                      step="1"
                      value={
                        margemLucroCustom !== null
                          ? margemLucroCustom
                          : config.margemLucro
                      }
                      onChange={(e) =>
                        setMargemLucroCustom(parseFloat(e.target.value) || 0)
                      }
                      style={{
                        width: "70px",
                        padding: "6px 8px",
            ...
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
              ...
              >
                <Save size={18} />
                {salvando ? t.salvando : t.salvarHistorico}
              </button>
            </div>
          </>
        )}
