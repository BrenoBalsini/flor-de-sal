    ...
    return (
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          />
          <p style={{ color: "#6B7280" }}>{t.carregandoDashboard}</p>
        </div>
      </div>
    );
  }
    ...
    <div className="page-container">
      <div className="content-wrapper">
        ...
        <div style={{ marginBottom: "32px" }}>
          ...
          >
            {t.ola}, {user?.displayName?.split(" ")[0]}!!
          </h1>
        ...
        >
          ...
          >
            ...
            >
              {t.moeda} {stats.valorInvestidoMateriais.toFixed(2)}
            </p>
          </div>
          ...
          >
            ...
            >
              {stats.totalProdutos > 0
                ? `${t.moeda} ${stats.valorMedioProdutos.toFixed(2)}`
                : "—"}
            </p>
          </div>
        </div>
          ...
          >
            ...
            {stats.produtoMaisCaro && (
              ...
              >
                ...
                >
                  {t.moeda} {stats.produtoMaisCaro.precoFinal.toFixed(2)}
                </p>
              </div>
            )}
            ...
            {stats.produtoMaisBarato && stats.totalProdutos > 1 && (
              ...
              >
                ...
                >
                  {t.moeda} {stats.produtoMaisBarato.precoFinal.toFixed(2)}
                </p>
              </div>
            )}
          </div>
