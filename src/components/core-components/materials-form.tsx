...
import { type MaterialFormData, type Material } from "../../types";

type MaterialFormProps = {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: MaterialFormData) => void;
  initialEditMaterial?: Material | null;
};
...
export default function MaterialForm({
  ...
  const isEditing = !!initialEditMaterial;

  useEffect(() => {
    if (initialEditMaterial) {
      const baseFormData = {
        ...initialState,
        name: initialEditMaterial.name,
        purchasePrice: initialEditMaterial.purchasePrice
          .toString()
          .replace(".", ","),
        purchaseDate: initialEditMaterial.purchaseDate,
        purchaseSource: initialEditMaterial.purchaseSource,
        unitType: initialEditMaterial.unitType,
      };

      switch (initialEditMaterial.unitType) {
        case "area":
          baseFormData.purchaseWidth =
            initialEditMaterial.purchaseWidth.toString();
          baseFormData.purchaseHeight =
            initialEditMaterial.purchaseHeight.toString();
          break;

        case "linear":
          baseFormData.purchaseLength =
            initialEditMaterial.purchaseLength.toString();
          break;

        case "unidade":
          baseFormData.purchaseQuantity =
            initialEditMaterial.purchaseQuantity.toString();
          break;
      }
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              type="date"
              name="purchaseDate"
              placeholder={formData.purchaseDate}
          ...
          <div>
            ...
            >
              ...
              <option value="linear">
                Por Comprimento (ex: fita, elástico)
              </option>
            ...
            <div className="rounded-md border p-4">
              ...
              <div>
                <Label htmlFor="purchaseQuantity">
                  Quantas unidades vieram? (ex: 10, 50)
                </Label>
                <Input
                  id="purchaseQuantity"
                  type="text"
          ...
          {formData.unitType === "area" && (
            <div className="grid grid-cols-2 gap-4 rounded-md border p-4">
              <h3 className="col-span-2 text-sm font-medium text-gray-400">
                Dimensões do Material Comprado
              </h3>
              <div>
